''' This code is copied from https://github.com/yun-liu/RCF-PyTorch/ and remove the sigmoid'''
import torch
...
class RCF(nn.Module):
    def __init__(self, classes, pretrained=None):
        ...
        self.score_dsn1 = nn.Conv2d(21, classes, 1)
        self.score_dsn2 = nn.Conv2d(21, classes, 1)
        self.score_dsn3 = nn.Conv2d(21, classes, 1)
        self.score_dsn4 = nn.Conv2d(21, classes, 1)
